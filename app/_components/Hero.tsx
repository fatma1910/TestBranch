  ...
  return (
    <div className="md:px-[82px] px-16 py-[84px] flex justify-between items-center ">
        <div className="lg:max-w-[541px]">
            ...
            <h1 className="md:text-[58px] text-[45px] font-semibold md:leading-[64px] leading-[45px] mb-2">The Future of <span className="text-main">Digital</span>  Certificates and Certifications</h1>
