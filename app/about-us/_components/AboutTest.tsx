...
const AboutTest = () => {
  return (
        <div className="md:px-[82px] px-16 py-[84px] flex justify-between items-center bg-[#F4F8E8]">
        <div className="lg:w-[582px] ">
            <h3 className="title">about test branch </h3>

            <h1 className="md:text-[40px]  font-semibold leading-[44px] -leading-4 mb-2 w-full">Elevating 
