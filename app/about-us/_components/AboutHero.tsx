...
const AboutHero = () => {
  return (
        ...
        <div className="lg:max-w-[541px]">
            ...
            <h1 className="md:text-[58px] text-[45px] font-semibold md:leading-[64px] leading-[45px] mb-2">Revolutionizing Digital  <span className="text-main">Certification</span> </h1>
